/* ============================================================
   CALENDARIO.JS - Calendário de Eventos 2026
   ============================================================ */
...
const eventos = {
    0: [
        { dia: 15, tipo: 'Audiência', titulo: 'Audiência Pública - Orçamento 2026', hora: '14h00', desc: 'Discussão do orçamento municipal com participação da comunidade.', seed: 'audience-jan' },
    ...
    1: [
        { dia: 5, tipo: 'Visita', titulo: 'Visita Técnica à Zona Leste', hora: '08h30', desc: 'Inspeção das obras de infraestrutura e escuta das demandas locais.', seed: 'visit-feb' },
    ...
    2: [
        { dia: 8, tipo: 'Evento', titulo: 'Encontro Mulheres da Nossa Gente', hora: '09h00', desc: 'Celebração do Dia Internacional da Mulher com debates e homenagens.', seed: 'women-mar' },
    ...
    3: [
        { dia: 2, tipo: 'Evento', titulo: 'Palestra Direitos do Cidadão', hora: '19h00', desc: 'Palestra aberta sobre como exercer a cidadania e participar da política local.', seed: 'rights-apr' },
    ...
    4: [
        { dia: 1, tipo: 'Evento', titulo: 'Café da Manhã com Trabalhadores', hora: '08h00', desc: 'Confraternização do Dia do Trabalho com lideranças sindicais.', seed: 'labor-may' },
        { dia: 9, tipo: 'Audiência', titulo: 'Audiência Pública - Meio Ambiente', hora: '14h00', desc: 'Discussão sobre áreas verdes, coleta seletiva e sustentabilidade.', seed: 'green-may' },
    ...
    5: [
        { dia: 5, tipo: 'Visita', titulo: 'Visita à Escola Municipal Paulo Freire', hora: '09h00', desc: 'Acompanhamento do início do segundo semestre letivo.', seed: 'school-jun' },
    ...
    6: [
        { dia: 3, tipo: 'Evento', titulo: 'Festa Julina Comunitária', hora: '18h00', desc: 'Arraiá beneficente com apresentações culturais e gastronomia local.', seed: 'fest-jul' },
        { dia: 8, tipo: 'Audiência', titulo: 'Audiência - Segurança Pública', hora: '14h00', desc: 'Debate sobre iluminação, patrulhamento e prevenção à violência.', seed: 'safe-jul' },
    ...
    7: [
        { dia: 5, tipo: 'Evento', titulo: 'Seminário Participação Popular', hora: '08h30', desc: 'Seminário de dois dias sobre orçamento participativo e controle social.', seed: 'semi-aug' },
    ...
    8: [
        { dia: 7, tipo: 'Evento', titulo: 'Desfile Cívico Independência', hora: '08h00', desc: 'Participação nas celebrações do 7 de Setembro com a comunidade.', seed: 'sep7-set' },
    ...
    9: [
        { dia: 5, tipo: 'Evento', titulo: 'Feira de Empreendedorismo Local', hora: '09h00', desc: 'Exposição de produtos de pequenos empreendedores com apoio do gabinete.', seed: 'ent-oct' },
    ...
    11: [
        { dia: 5, tipo: 'Evento', titulo: 'Natal Solidário Comunitário', hora: '17h00', desc: 'Entrega de cestas e brinquedos com apresentação da banda comunitária.', seed: 'xmas-dec' },
...
function renderEventos(mesIndex) {
    ...
    lista.forEach((ev, index) => {
        ...
        card.className = 'event-card-cal';
        card.style.animationDelay = `${index * 0.08}s`;
        card.style.animation = 'slideIn 0.4s ease both';
        ...
        card.innerHTML = `
            ...
            <div class="event-visual">
                ...
                <div class="event-info-cal">
                    <h3 class="event-title-cal">${ev.titulo}</h3>
                    <span class="event-time-cal">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"></circle><polyline points="12 6 12 12 16 14"></polyline></svg>
                        ${ev.hora}
                    </span>
                    <p class="event-desc-cal">${ev.desc}</p>
                </div>
            </div>
        `;
